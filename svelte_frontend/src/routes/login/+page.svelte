	...
	<div class="max-w-md w-full space-y-8">
		...
		<form class="mt-8 space-y-6" on:submit|preventDefault={handleLogin}>
			<div class="space-y-4">
				...
				<div>
					<label for="password" class="block text-base font-medium text-gray-700"></label>
					<input
						id="password"
						type="password"
						placeholder="Senha"
			...
			<div class="text-center">
				<a href="/register" class="text-blue-600 hover:text-blue-700 text-base">Não tem conta? Cadastre-se</a>
			</div>
		</form>
	</div>
</div>