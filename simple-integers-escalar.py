...
def main():
    ...
    # Forma escalar
    plaintext1 = crypto_context.MakeCoefPackedPlaintext([5])
    plaintext2 = crypto_context.MakeCoefPackedPlaintext([3])
    plaintext3 = crypto_context.MakeCoefPackedPlaintext([7])
    # ou plaintext1 = crypto_context.MakePlaintext("5")
